...
public class MultiRequestBodyArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public boolean supportsParameter(MethodParameter parameter) {
		...
		return parameter.hasParameterAnnotation(com.kplan.phonecard.web.annotation.MultiRequestBody.class);
	}
	...
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
		...
		HashMap jsonObject = objectMapper.readValue(jsonBody, HashMap.class);
//		JSONObject jsonObject = JSON.parseObject(jsonBody);
		...
		if (value != null) {
			...
			// 其他复杂对象
			return objectMapper.readValue(jsonBody, parameterType);
//			return JSON.parseObject(value.toString(), parameterType);
		...
		result = objectMapper.readValue(jsonObject.toString(), parameterType);
