...
/**
 * 中文数字翻译工具 Created by hanwen on 2016/11/28.
 */
public abstract class NumberZhTranslator {
	...
	private static String translateNumber(char[] romanArray, boolean simplified) {
		...
		if (length == 1) {
			...
			return translateNumber(higherArray, simplified) + zhHundredMillion
					+ translateNumber(lowerArray, simplified);
	 ...
	 * @return
	 */
	private static String translate4NumberChar(char kilobitChar, char hundredsPlaceChar, char decadeChar,
			char theUnitChar, boolean simplified) {
		...
		return translate1NumberChar(kilobitChar, simplified, true) + zh1000
				+ translate3NumberChar(hundredsPlaceChar, decadeChar, theUnitChar, simplified);
	}
	 ...
	 * @return
	 */
	private static String translate3NumberChar(char hundredsPlaceChar, char decadeChar, char theUnitChar,
			boolean simplified) {
		int hundredsPlace = numberCharToInt(hundredsPlaceChar);
		int decade = numberCharToInt(decadeChar);
		int theUnit = numberCharToInt(theUnitChar);
		...
		return translate1NumberChar(hundredsPlaceChar, simplified, true) + zh100
				+ translate2NumberChar(decadeChar, theUnitChar, simplified, false);
	}
